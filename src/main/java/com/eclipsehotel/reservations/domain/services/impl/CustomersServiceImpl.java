...
public class CustomersServiceImpl {
    ...
    public CustomersResponseDTO saveCustomer(CustomersRequestDTO dto) {
        ...
        var responseCep = cepService.consultarCep(dto.zipCode());
    ...
    private CustomersEntity updateCustomer(CustomerUpdateRequestDTO dto, CustomersEntity entity) {
        ...
        if (!dto.zipCode().equals(entity.getAddress().getZipCode())) {
            var response = cepService.consultarCep(dto.zipCode());
        ...
        if (dto.addressDetails() != null) address.setAddressDetails(dto.addressDetails());
        return entity;
    }
